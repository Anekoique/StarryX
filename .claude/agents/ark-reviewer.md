---
name: ark-reviewer
description: Use during REVIEW (deep tier) to judge `PLAN.md` against the PRD, project SPECs, and feature SPECs. Writes verdict + `R-NNN` findings into the seeded `REVIEW.md`. Read-only otherwise.
