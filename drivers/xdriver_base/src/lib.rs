...
//! device types:
//!
//! - [`xdriver_block`][2]: Common traits for block storage drivers.
//! - [`xdriver_display`][3]: Common traits and types for graphics display drivers.
//! - [`xdriver_net`][4]: Common traits and types for network (NIC) drivers.
//!
//! [1]: https://github.com/arceos-org/arceos
//! [2]: ../xdriver_block/index.html
//! [3]: ../xdriver_display/index.html
//! [4]: ../xdriver_net/index.html
