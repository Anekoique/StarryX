...
#[cfg(feature = "net")]
pub type XNetDevice = Box<dyn NetDriverOps>;
/// The unified type of the block storage devices.
#[cfg(feature = "block")]
pub type XBlockDevice = Box<dyn BlockDriverOps>;
/// The unified type of the graphics display devices.
#[cfg(feature = "display")]
pub type XDisplayDevice = Box<dyn DisplayDriverOps>;
...
pub struct XDeviceContainer<D>(Vec<D>);
