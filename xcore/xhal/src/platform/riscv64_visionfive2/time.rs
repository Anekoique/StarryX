...
const NANOS_PER_TICK: u64 = crate::time::NANOS_PER_SEC / xconfig::devices::TIMER_FREQUENCY as u64;
...
pub(super) fn init_early() {
    #[cfg(feature = "rtc")]
    if xconfig::devices::RTC_PADDR != 0 {
        use crate::mem::phys_to_virt;
        use memory_addr::PhysAddr;
        use riscv_goldfish::Rtc;

        const GOLDFISH_BASE: PhysAddr = pa!(xconfig::devices::RTC_PADDR);
