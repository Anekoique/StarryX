...
//!
//! ```
//! use xlog::{debug, error, info, trace, warn};
//!
//! // Initialize the logger.
//! xlog::init();
//! // Set the maximum log level to `info`.
//! xlog::set_max_level("info");
//!
...
///
/// Equivalent to the [`x_println!`] macro except that a newline is not printed at
